...
export const AuthScreen: React.FC = () => {
  ...
  const { loginWithPin, isLoading, error } = useBank();
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-between p-8 text-white font-sans overflow-hidden relative">
      ...
      <div className="z-10 mt-12 flex flex-col items-center">
        <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl flex items-center justify-center font-bold text-4xl shadow-2xl shadow-orange-500/20 mb-6">
          A
        </div>
        ...
        <div className="mt-2 px-3 py-1 bg-orange-500/10 border border-orange-500/20 rounded-full">
          <p className="text-[10px] font-bold text-orange-500 uppercase tracking-widest">Secure Environment</p>
        </div>
      </div>

      <div className="z-10 w-full max-w-xs flex flex-col items-center space-y-12">
        <div className="text-center">
          <p className="text-slate-400 text-sm font-medium mb-4">Enter Secure PIN</p>
          ...
          {error && <p className="text-red-500 text-xs mt-4 font-bold uppercase tracking-tighter">{error}</p>}
        </div>
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="flex space-x-8">
            ...
            <button className="text-xs font-bold text-slate-500 uppercase tracking-widest hover:text-white transition-colors">Register</button>
          </div>
        </div>
      ...
      <div className="z-10 text-center pb-8">
        ...
        <p className="text-[9px] text-slate-600 uppercase font-bold tracking-widest max-w-[200px]">Licensed to AccessClone Financial Services Corp. End-to-end Encrypted.</p>
      </div>
    </div>
  );
};
